...
public interface GameRoomRepository {
	...
	void insertGameInform(String roomId, String gameMode, HashMap<Integer, QuizVO> quiz) throws JsonProcessingException;
	int saveGameInform();
	...
	void insertGameInform(String roomId, String roomTitle, String gameMode, HashMap<Integer, QuizVO> quiz)
