...
public class GameController {
    ...
    public String resultPage(Model model, HttpSession session) throws JsonMappingException, JsonProcessingException {
        quizService.insertHistoryAndDeleteGameRoom(session, model);
        return "result";
    }
    ...
    public boolean correct(@RequestParam(name = "correct") String correct, HttpSession session) throws JsonMappingException, JsonProcessingException {
        return quizService.checkAnswer(correct, session);
    }
