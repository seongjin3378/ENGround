 ...
 -->
        ...
        <div class="onlineGame-container">
            <div class="onlineGame-header">  
                <span class="onlineGame-score"><span id="correct-question">0</span>/10 | 100점</span>
            </div>
            <div class="onlineGame-input-container">
                ...
                <div class="onlineGame-input-box" id="answer-blank">_ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _</div>
...
<script type="module" src="<c:url value='/resources/js/gameStomp.js' />" defer></script>
</html>
